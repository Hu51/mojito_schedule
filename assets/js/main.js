(function () {
    ...
    ScheduleTemplate.prototype.placeEvents = function () {
        ...
        for (let i = 0; i < this.singleEvents.length; i++) {
            const anchor = this.singleEvents[i].getElementsByTagName('a')[0];
            const start = getScheduleTimestamp(anchor.getAttribute('data-start')),
                duration = getScheduleTimestamp(anchor.getAttribute('data-end')) - start;

            const eventTop = slotHeight * (start - self.timelineStart) / self.timelineUnitDuration,
    ...
    ScheduleTemplate.prototype.openModal = function (target) {
        ...
        if (mq === 'mobile') {
            ...
            const eventPosition = target.getBoundingClientRect(),
            ...
            const modalTranslateX = parseInt((windowWidth - modalWidth) / 2 - eventLeft),
    ...
    ScheduleTemplate.prototype.closeModal = function () {
        ...
        const item = self.element.getElementsByClassName('cd-schedule__event--selected')[0],
        ...
        if (mq === 'mobile') {
            ...
            const modalStyle = window.getComputedStyle(self.modal),
